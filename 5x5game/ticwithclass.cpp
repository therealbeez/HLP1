...
int checkwin(){
    ...
    int r= getmultiple(choice);
    int rneg1= getmultiple(choice-1);
    int rneg2= getmultiple(choice-2);
    int rneg4= getmultiple(choice-4);
    int rneg8= getmultiple(choice-8);

    int rpos1= getmultiple(choice+1);
    int rpos2= getmultiple(choice+2);
    int rpos4= getmultiple(choice+4);
    int rpos8= getmultiple(choice+8);
